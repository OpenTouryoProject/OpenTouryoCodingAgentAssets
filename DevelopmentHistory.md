...
opentouryo-webforms-dialog         実効164L tok~2601  完了（子画面表示・ダイアログ。ブラウザ・ウィンドウ別／親画面別 Session 領域＝入れ子2層）
